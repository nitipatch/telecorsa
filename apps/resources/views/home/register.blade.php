...
//////////////////////////////////////////////////-----Facebook-----/////  
        ...
        $loginUrl = $helper->getLoginUrl('https://localhost/telecorsa/fb-callback.php',['email']);
//////////////////////////////////////////////////-----Google-----/////
...
/////////////////////////////////////////////////////////////
            ...
            <div class="content" style="margin-top:0; padding-top:0px; background:url(images/bodybg.jpg) top center no-repeat #010101">
            	<div class="contactbac">
                	<div class="container" style="background:#FFF; padding-top:0px">
                    	<div class="notlogin">
    <h3>Quickly sign up with:</h3>
    <label><input type="checkbox" style="margin-right:10px">I have read and agree to the Telecorsa Interactive Terms of Use and Privacy Policy. I understand I will receive the Telecorsa Insider and Roadshow newsletters (you can opt out at any time).</label>
    <div class=" agree"></div>
    	<div class="col-5">
    	  <div class="social-authenticate">
            <a onclick="window.open('<?php echo $loginUrl;?>', 'newwindow', 'top=50, left=200, width=600, height=400'); return false;" href="#"><img src="images/sub/socialbut_03.jpg"  alt=""/></a>
            
            <a onclick="window.open('<?php echo $authUrl;?>', 'newwindow', 'top=50, left=200, width=480, height=320'); return false;" href="#"><img src="images/sub/socialbut_05.jpg" alt=""/></a>
            
            <a onclick="window.open('yahoo.php', 'newwindow', 'top=50, left=200, width=480, height=600'); return false;" href="#"><img src="images/sub/socialbut_06.jpg"  alt=""/></a>        
        </div>
      </div>
    ...
    <div class="authenticate">
        ...
        <div class="emailAddr"><input required type="text" name="emailAddr" id="emailAddr" placeholder="E-MAIL ADDRESS" class="login_email"></div>
            ...
            @endif
        <div class="gender">
            <!-- <input required type="text" name="gender"    id="gender"    placeholder="GENDER" class="login_email"> -->
        ...
        {!! Form::submit('REGISTER', ['class' => 'btn-link']) !!}
    ...
    <label><input type="checkbox" style="margin-right:20px">Get tech tips from Telecorsa editors e-mailed to you.</label>
    <p style="padding-top:10px; border-top:1px solid #CCC">Already have an account? <a href="login" class="red">Log in here.</a></p>
    </div>
    </div>
    </div>
    </div>
